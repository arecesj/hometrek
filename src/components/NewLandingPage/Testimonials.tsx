...
import Jeewan from '@/images/jeewan.png'
        ...
        <div className="py-12 md:py-20">
          ...
          {/* <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">
                100+ interviews with realtors and home buyers
              </h4>
            </div>

            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">
                Built and launched an MVP in less than two months
              </h4>
            </div>
          ...
          <div className="max-w-3xl mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-2 items-start md:max-w-2xl lg:max-w-none" data-aos="zoom-y-out">
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  <Image className="relative rounded-full" src={Jeewan} width={96} height={96} alt="Jeewan" />
                </div>
                <blockquote className="text-xl font-medium mb-4">
                  “ Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">Jeewan Singh</cite>
                <div className="text-gray-600">
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  <Image className="relative rounded-full" src={Juan} width={96} height={96} alt="Cutie" />
                </div>
                <blockquote className="text-xl font-medium mb-4">
                “ Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">Juan Areces</cite>
                <div className="text-gray-600">
